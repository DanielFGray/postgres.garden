declare module "d3-flextree" {
  ...
  export function flextree<Datum>(opts: {
    ...
    spacing?:
      | number
      | ((nodeA: FlexHierarchyPointNode<Datum>, nodeB: FlexHierarchyPointNode<Datum>) => number);
  ...
  export interface FlexHierarchyPointNode<Datum> extends d3.HierarchyPointNode<Datum> {
    /**
     * The horizontal size
     */
    xSize: number;
